  ...
  return (
    <div>
      ...
      <div className="navbar flex h-20 flex-row md:mb-2 shadow-lg bg-black text-neutral-content border-b border-zinc-600 bg-opacity-66">
        ...
        <img src={Logo.src} alt="MediFund Logo" className="h-10 w-auto" />
        </div>
        ...
        <div className="navbar-end">
          <div className="hidden md:inline-flex align-items-center justify-items gap-6">
            ...
            <Link href="/campaigns" legacyBehavior><a>Campaigns</a></Link>
            <Link href="/manage-hospitals" legacyBehavior><a>Manage Hospitals</a></Link>
            <Link href="/approve-campaigns" legacyBehavior><a>Approve Campaigns</a></Link>
